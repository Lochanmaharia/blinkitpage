...
function App() {
  ...
  return (
    <div className='mx-auto'>
      ...
      {/* Top image*/}
      <img
        className='w-full max-w-7xl mx-auto pt-[170px] lg:pt-[90px]'
      ...
      />
      {/* Emergency Section*/}
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 md:w-7xl mx-auto gap-5 mt-4 pl-4 md:pr-55 '>
        <a href=""><img className='w-full rounded-xl' src="https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=720/layout-engine/2023-07/pharmacy-WEB.jpg" alt="" /></a>
        <a href=""><img className='w-full rounded-xl' src="https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=720/layout-engine/2026-01/pet_crystal_WEB-1.png" alt="" /></a>
        <a href=""> <img className='w-full rounded-xl' src="https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=720/layout-engine/2026-01/baby_crystal_WEB-1.png" alt="" /></a>
